...
#pve_playtime .foreground-circle {
  stroke: #ff4400;
}
...
.player-skills .playtime-circles {
  float: left;
  width: 100%;
  max-width: 125px;
  height: 255px;
...
.player-skills .playtime-circles > div {
...
export default {
 ...
 //  const x1 = totalTime/100
   ...
   // circliful.newCircle({
   //   percent: Math.ceil(pvpPlayTime/x1),
   //   text: "PVP",
   //   id: 'pvp_playtime',
   //   type: 'simple',
...
//
   // circliful.newCircle({
   //   percent: Math.ceil(pvePlayTime/x1),
   //   text: "PVE",
   //   id: 'pve_playtime',
   //   type: 'simple',
   //   color: "#ff4400",
